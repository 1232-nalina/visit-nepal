...
<form method="POST" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="file"  name="post_image"class="form-control" placeholder="post icon" required/>
	</div>
	<div class="form-group">
    ...
    <div class="form-group">
		...
		<textarea name="post_price" class="form-control">
		</textarea>
	</div>
	<div class="form-group">
...
include("../connect.php");
	if(isset($_POST['btn-submit']))
	{
		...
		$sql="insert into packagee_tbl(title,image,description,price)values('$title','$img','$desc','$price')";
